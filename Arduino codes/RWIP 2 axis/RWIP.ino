...
float   Kp_A = -689.3;               //proportional coefficient for motor A
float   Kd_A = -66.4;               //differential coefficient for motor A
float   Ki_A = 1;              //integral coefficient for motor A
...
float   Kp_B = -689.3;               //proportional coefficient for motor B
float   Kd_B = -66.4;                //differential coefficient for motor B
float   Ki_B = 1;              //integral coefficient for motor B
